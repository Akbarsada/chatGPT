...
if(!class_exists('\\WPAICG\\WPAICG_Hook')) {
    class WPAICG_Hook
    {
        ...
        public function __construct()
        {
            ...
            add_editor_style(CHATGPT_PLUGIN_URL.'admin/css/editor.css');
        ...
        {
            wp_enqueue_script('wpaicg-jquery-datepicker',CHATGPT_PLUGIN_URL.'admin/js/jquery.datetimepicker.full.min.js',array(),null);
            wp_enqueue_style('wpaicg-extra-css',CHATGPT_PLUGIN_URL.'admin/css/wpaicg_extra.css',array(),null);
            wp_enqueue_style('wpaicg-jquery-datepicker-css',CHATGPT_PLUGIN_URL.'admin/css/jquery.datetimepicker.min.css',array(),null);
        }
