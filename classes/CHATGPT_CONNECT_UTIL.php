...
if(!class_exists('\\CHATGPT_CONNECT\\CHATGPT_CONNECT_UTIL')) {
    class CHATGPT_CONNECT_UTIL
    {
...
if(!function_exists(__NAMESPACE__.'\chatgpt_util_core')){
    function chatgpt_util_core(){
        return CHATGPT_CONNECT_UTIL::get_instance();
    }
}
