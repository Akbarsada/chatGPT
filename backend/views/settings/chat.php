...
<p>Learn how you can teach your content to the chat bot: <u><b><a href="https://youtu.be/NPMLGwFQYrY" target="_blank">https://youtu.be/NPMLGwFQYrY</a></u></b></p>
    ...
    <!--More fields-->
    <?php
    $wpaicg_chat_temperature = get_option('wpaicg_chat_temperature',$db_Value['temperature']);
    $wpaicg_chat_max_tokens = get_option('wpaicg_chat_max_tokens',$db_Value['max_tokens']);
    $wpaicg_chat_top_p = get_option('wpaicg_chat_top_p',$db_Value['top_p']);
    $wpaicg_chat_best_of = get_option('wpaicg_chat_best_of',$db_Value['best_of']);
    $wpaicg_chat_frequency_penalty = get_option('wpaicg_chat_frequency_penalty',$db_Value['frequency_penalty']);
    $wpaicg_chat_presence_penalty = get_option('wpaicg_chat_presence_penalty',$db_Value['presence_penalty']);
    ?>
    <div class="wpcgai_form_row">
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Additional Context?:</label>
        <input<?php echo $wpaicg_chat_content_aware == 'no' || ($wpaicg_chat_embedding && $wpaicg_chat_content_aware == 'yes') ? ' disabled':''?><?php echo $wpaicg_chat_addition == 'yes' ? ' checked': ''?><?php echo $wpaicg_chat_content_aware == 'no' ? ' disabled':''?> name="wpaicg_chat_addition" value="1" type="checkbox" id="wpaicg_chat_addition">
    </div>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Context:</label>
        <textarea<?php echo $wpaicg_chat_content_aware == 'no' || ($wpaicg_chat_embedding && $wpaicg_chat_content_aware == 'yes')  || !$wpaicg_chat_addition ? ' disabled':''?><?php echo $wpaicg_chat_content_aware == 'no' ? ' disabled':''?> class="regular-text" id="wpaicg_chat_addition_text" name="wpaicg_chat_addition_text"><?php echo esc_html($wpaicg_chat_addition_text)?></textarea>
    </div>
    <div class="wpcgai_form_row">
    ...
    <div class="wpcgai_form_row">
        ...
        <div style="display: inline-flex; align-items: center">
            ...
            <div style="text-align: center">
                <img style="display: block" src="<?php echo CHATGPT_PLUGIN_URL.'admin/images/chatbot.png'?>"<br>
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Footer Note:</label>
        <input value="<?php echo esc_html($wpaicg_footer_text)?>" type="text" name="wpaicg_chat_widget[footer_text]" placeholder="Powered by ...">
    </div>
    <div class="wpcgai_form_row">
    ...
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Text Field Background:</label>
        <input value="<?php echo esc_html($wpaicg_bg_text_field)?>" type="text" class="wpaicgchat_color" name="wpaicg_chat_widget[bg_text_field]">
    </div>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Text Field Border:</label>
        <input value="<?php echo esc_html($wpaicg_border_text_field)?>" type="text" class="wpaicgchat_color" name="wpaicg_chat_widget[border_text_field]">
    </div>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Button Color:</label>
        <input value="<?php echo esc_html($wpaicg_send_color)?>" type="text" class="wpaicgchat_color" name="wpaicg_chat_widget[send_color]">
    </div>
    <div class="wpcgai_form_row">
        <label class="wpcgai_label">Background Color:</label>
        <input value="<?php echo esc_html($wpaicg_chat_bgcolor)?>" type="text" class="wpaicgchat_color" name="wpaicg_chat_widget[bgcolor]">
    ...
    <div class="wpcgai_form_row">
        ...
        <div style="display: inline-flex; align-items: center">
            ...
            <div style="text-align: center">
                <img style="display: block;width: 40px; height: 40px" src="<?php echo CHATGPT_PLUGIN_URL.'admin/images/chatbot.png'?>"<br>
                <strong>Default</strong>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
