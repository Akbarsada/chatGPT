...
class Chatgpt_Define {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Chatgpt_Define_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
    ...
    public function __construct() {
        if ( defined( 'CHATGPT_CONNECT_VERSION' ) ) {
            $this->version = CHATGPT_CONNECT_VERSION;
        } else {
            $this->version = '1.0.0';
        }
        $this->plugin_name = 'chatgpt_connect';
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/Chatgpt_Define_Loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/Chatgpt_Languages.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'backend/Chatgpt_Admin.php';
         ...
         * side of the site.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/Chatgpt_Public.php';

        $this->loader = new Chatgpt_Define_Loader();
    ...
    private function set_language() {
        ...
        $plugin_languages = new Chatgpt_Languages();

        $this->loader->add_action( 'plugins_loaded', $plugin_languages, 'load_plugin_textdomain' );
    ...
    private function define_admin_hooks() {
        ...
        $plugin_admin = new Chatgpt_Admin( $this->get_plugin_name(), $this->get_version() );
    ...
    private function define_public_hooks() {
        ...
        $plugin_public = new chatgpt_public( $this->get_plugin_name(), $this->get_version() );
     ...
     *
     * @since     1.0.0
     * @return    Chatgpt_Define_Loader    Orchestrates the hooks of the plugin.
     */
